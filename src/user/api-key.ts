    ...
    <div class="key-guide">
      ...
      <ol class="key-guide-steps">
        ...
        <li>
          ...
          <div class="key-guide-note">
            При подключении мы автоматически переключим ваш аккаунт в режим
            <b>«One-Way»</b> (без хеджа) и <b>«Cross margin»</b> (общий залог).
            Это наши требования к настройкам — наш расчёт риска и Safety SL
            работают только в cross-режиме. Если у вас на счёте уже есть
            открытые позиции в hedge или isolated — закройте их перед подключением,
            иначе Bybit не даст нам сменить настройки.
          </div>
        </li>
      </ol>
