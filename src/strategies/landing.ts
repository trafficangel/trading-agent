...
export async function landingRoute(app: FastifyInstance): Promise<void> {
  ...
  app.get('/llms.txt', async (_req, reply) => {
    ...
    return [
      ...
      '## Pricing tiers',
      '',
      '- **Starter** ($12/mo, deposit $300–$799, 4 strategies)',
      '- **Standard** ($35/mo, deposit $800–$2 499, 5 strategies)',
      '- **Plus** ($90/mo, deposit $2 500–$5 999, 6 strategies)',
      '- **Pro** ($235/mo, deposit $6 000–$14 999, 6 strategies, larger sizes)',
      '- **VIP** ($580/mo, deposit $15 000+, custom)',
      '- **Prof** ($99/mo, manual control of position size + leverage, 9 strategies)',
      '',
      '## Key pages',
      '',
