...
const STRATEGIES: StrategyDef[] = [
  {
    ...
    description: [
      ...
      'Размер ставки — дробный Келли (1/4) от банка $100: ставка = ¼ · f · банк, где f = p − (1−p)/b (p — фактический процент выигрышей этой стратегии, b — коэффициент входа); минимум $1, потолок $10. Банк растёт — ставка плавно растёт; нет перевеса — ставим минимум. Келли не создаёт преимущества, а лишь превращает уже имеющееся в плавный рост и страхует от разорения.',
    ],
  },
  {
    slug: 'egsnap',
  ...
  },
  {
    ...
    description: [
      ...
      'Как считается ставка (дробный Келли 1/4). Стартовый банк — $100; банк = старт + накопленный PnL. Формула Келли даёт оптимальную долю банка f = p − (1−p)/b, где p — наша вероятность выигрыша, b = (1−цена)/цена — коэффициент. Ставим ЧЕТВЕРТЬ от этой доли (1/4 Келли — чтобы сгладить колебания), умноженную на текущий банк. Чем сильнее перевес нашей оценки над ценой и выгоднее коэффициент — тем больше ставка; нет перевеса (f≤0) — ставим минимум $1. Жёсткий потолок $10. Банк растёт — ставка плавно растёт (компаундинг); банк просел — ставка САМА уменьшается.',
  ...
  },
  {
    ...
    description: [
      ...
      'Размер ставки — дробный Келли (1/4) от банка $100: ставка = ¼ · f · банк, где f = p − (1−p)/b (p — фактический процент выигрышей этой стратегии, b — коэффициент входа); минимум $1, потолок $10. На очень дешёвом «замке» коэффициент большой, поэтому Келли сам ставит осторожно. Келли не создаёт преимущества — лишь превращает уже имеющееся в плавный рост и страхует от разорения.',
    ],
  },
  {
    slug: 'favprog',
