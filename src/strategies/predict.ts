...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Размер ставки — дробный Келли (1/4) от банка: ¼ · f · банк, само-калибровка по фактическому винрейту, потолок ~30% банка, минимум $1. f = p − (1−p)/b; вход только при f>0. На реале минимальная заявка Polymarket ≈ 5 акций — нужен депозит с запасом.',
    ],
  },
  {
    slug: 'egcombo',
  ...
  },
  {
    ...
    tagline: 'Флагман: откалиброванная вероятность по нашим данным + фильтры комбо + vol-режим + антизапаздывание',
    ...
    description: [
      ...
      'Поверх — все подтверждённые фильтры: цена ≤0.65, сильный сигнал z≥1.5, сессия Азия+Европа (00–13 UTC), вход только при положительном крае f>0.',
...
const MIN_DEPOSIT_BY_SLUG: Record<string, number> = {
  eglate: 20, egedge: 20, egcombo: 20, egcal: 20, egprog: 20,
};
