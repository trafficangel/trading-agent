...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'ПОЧЕМУ РАБОТАЕТ. На цене 0.50 рынок считает раунд монеткой 50/50. Но у дедлайна даже небольшой перевес обычно удерживается (развернуться уже не успеть), а рынок осторожно держит цену у середины. Этот разрыв — между реальной устойчивостью малого перевеса и осторожной ценой рынка — и есть наш край. На фаворите рынок уже всё оценил, края нет.',
      'КАК ВХОДИТ. Только когда цена ведущей стороны в зоне 0.45–0.54 (коэф ~1.85–2.2) И есть направленный перевес. Всё дороже — мимо (там доказанный минус). Вероятность — та же откалиброванная по 407 сделкам.',
      'ДЕНЬГИ — КОНСЕРВАТИВНО (рост без большого риска): ⅛-Kelly от осторожного винрейта, потолок ставки 10% банка, минимум $1.',
      '🧪 СТАТУС: ФОРВАРД-ВАЛИДАЦИЯ. Исторический край найден на 49 побочных входах за 2 дня — этого мало, чтобы рисковать реальными деньгами. Стратегия копит чистую forward-статистику. Планка перед допуском к реалу: винрейт ≥70% на коэф ≥1.9 на 150+ форвард-сделках. Честно: пока это гипотеза с сильным сигналом, а не доказанный факт.',
    ],
  },
  {
    slug: 'mart',
