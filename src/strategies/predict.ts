...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    description: [
      ...
      '1) Уверенность направления: суммарный модуль перевеса ≥ 0.8. На практике это значит, что вход даёт одно свежее подтверждение Confirmation (основной сигнал LuxAlgo); усиленное Confirmation+ — тем более. Развороты считаются с малым весом (они контртрендовые и шумные), поэтому сами по себе вход не дают.',
      ...
      'Когда раунд пропускаем. Нет свежих сигналов (фид молчит); перевес слабый (модуль < 0.8); цена нужной стороны вне полосы 0.35–0.65 (рынок уже согласен с направлением — платить будет мало); не хватает времени или ликвидности. Принцип простой: лучше пропустить, чем войти на шуме.',
