...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Честно. Это направленная ставка по индикатору. Сигналы LuxAlgo запаздывают и могут перерисовываться, а угадывание направления на 5-минутном BTC у нас нигде не дало устойчивого плюса — поэтому прибыль НЕ гарантирована. Снятие фильтра ≤0.50 убирает покупку заведомо проигрывающей стороны, но преимущество появится, только если само направление реально предсказывает исход. Проверяем строго по статистике; параметры не публикуем.',
    ],
  },
  {
    slug: 'mm',
