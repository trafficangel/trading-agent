...
const STRATEGIES: StrategyDef[] = [
  ...
  {
    slug: 'scalp',
    title: 'Probability Scalp',
    tagline: 'Тот же вход, но фиксируем переоценку (take-profit + стоп)',
    statusEnv: 'PREDICT_SCALP_STATUS_PATH',
    ...
    description: [
      ...
      'Зачем: по данным bid нашей стороны почти всегда подтягивается вверх после входа. Это даёт гораздо более РОВНУЮ кривую (меньше дисперсия), чем «всё или ничего» при удержании. Важно честно: скальп снижает риск, но сам по себе не создаёт прибыль — она появится, только если у входов есть реальный перевес. Сравниваем с обычным Probability Engine на тех же рынках.',
    ],
  },
  {
    slug: 'martingale',
