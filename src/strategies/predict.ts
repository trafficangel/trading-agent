...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    tagline: 'Ставка на аутсайдера при коэф. 3 + прогрессия Фибоначчи',
    statusEnv: 'PREDICT_MART_STATUS_PATH',
    statusFile: 'predict-mart-status.json',
    showStakeCol: true,
    description: [
      'Стратегия ждёт момент в раунде, когда коэффициент одной из сторон вырастает до 3 (цена ≤ 0.333) — то есть рынок оценивает её как аутсайдера с шансом ~33%. Ставим на эту сторону: если она всё же побеждает, выплата примерно 3:1.',
      'Размер ставки — система Фибоначчи от $0.1: 0.1, 0.1, 0.2, 0.3, 0.5, 0.8, 1.3, 2.1, 3.4… После проигрыша делаем следующий шаг последовательности, после выигрыша возвращаемся к стартовым $0.1. Потолок серии — 20 шагов.',
      'Честно: у ставки на аутсайдера по справедливому коэффициенту нет встроенного эджа — с учётом спреда матожидание отрицательное. Прогрессия лишь распределяет риск во времени и до крупной просадки выглядит ровно. Накопленная статистика покажет правду.',
    ],
  },
];
