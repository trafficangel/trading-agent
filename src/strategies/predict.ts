...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    tagline: '⏹ ЗАВЕРШЕНА (итог: винрейт 51% при необходимых 62% — статистически решена в минус, p=0.01, n=134). Остановлена 11.06 по аудиту.',
  ...
  },
  {
    ...
    tagline: '⏹ ЗАВЕРШЕНА (итог: 0 входов за 719 раундов — фильтры отсекали всё; честно закрыта, а не «полуживой флагман»). Остановлена 11.06.',
  ...
  },
  {
    ...
    tagline: '⏹ ЗАВЕРШЕНА (итог: винрейт 28% при необходимых 31% — край андердога коэф-3 не существует, p=0.04). Подтвердила: Келли не спасает без края. Остановлена 11.06.',
  ...
  },
  {
    ...
    tagline: '⏹ ЗАВЕРШЕНА (итог: −$392, просадка $432 = 4+ банка — Монте-Карло о разорительности мартингейла подтверждён эмпирикой). Остановлена 11.06.',
  ...
  },
  {
    ...
    tagline: '⏹ ЗАВЕРШЕНА (итог: −$111 — короткая прогрессия мягче (просадка $131 vs $432), но EV тот же минус). Остановлена 11.06.',
