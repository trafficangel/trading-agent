...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    tagline: 'Держим направление последнего Confirmation LuxAlgo (1m); вход на эту сторону при цене 0.30–0.85',
    ...
    description: [
      ...
      'Вход. Каждый раунд входим на сторону по нашему направлению, если её цена в полосе 0.30–0.85 (не лезем в пыль <0.30 и в почти решённые >0.85). Раньше был фильтр «только дёшево» (цена ≤0.50), но он заставлял покупать сторону, которая сейчас проигрывает (она потому и дешёвая) — это давало отрицательный результат. Теперь берём сторону сигнала по рынку, без перекоса в аутсайдера.',
      'Когда раунд пропускаем. Нет актуального направления (направленного сигнала не было дольше 4 часов); цена нужной стороны вне полосы 0.30–0.85; не хватает времени или ликвидности.',
