...
const CHANGELOG: ChangeEntry[] = [
  {
    date: '2026-06-11',
    title: 'Карточка Коэф-2 убрана; DYNPROB показывает ¼-Келли поверх юнит-трека',
    items: [
      'Карточка «Коэф-2 · мейкер-тест» снята с дашборда. Сам движок остаётся работать как технический фид котировок и резолюций для DYNPROB (без публичной карточки).',
