...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    hasLive: true,
    description: [
      'Стратегия следует за сигналами Confirmation индикатора LuxAlgo с минутного графика BTC. Алерты из TradingView приходят на наш сервер вебхуком на закрытии каждого 1-минутного бара. Размер ставки фиксированный — $15 на раунд; позицию держим до конца 5-минутного окна.',
