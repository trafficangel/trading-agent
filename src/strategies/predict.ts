...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    description: [
      ...
      'Свежесть сигналов. Триггеры-события (подтверждения и развороты) «живут» 6 минут и плавно затухают — старый сигнал влияет слабее свежего. Тренд-фон (Catcher / Tracer) держится дольше, до 10 минут, как устойчивое направление между событиями.',
      ...
      '2) Свежий повод: за последние 6 минут было хотя бы одно событие (подтверждение или разворот). На одном застывшем тренде, без свежего триггера, мы не входим.',
      '3) Ценность и время: цена нужной стороны в полосе 0.30–0.72 (рынок ещё не задрал её вверх — иначе выплата мала); до закрытия раунда осталось достаточно времени (входим в окне примерно от 4 минут до 5 секунд до конца); в стакане есть нужная ликвидность.',
      'Когда раунд пропускаем. Нет свежих сигналов (фид молчит); перевес слабый (модуль < 0.8); цена нужной стороны вне полосы 0.30–0.72 (рынок уже согласен с направлением — платить будет мало); не хватает времени или ликвидности. Принцип простой: лучше пропустить, чем войти на шуме.',
