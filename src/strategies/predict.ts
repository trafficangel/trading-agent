...
const STRATEGIES: StrategyDef[] = [
  ...
  },
  {
    ...
    description: [
      ...
      '1) Уверенность направления: суммарный модуль перевеса ≥ 1.5. Например, одно усиленное подтверждение (вес 2) — или обычное подтверждение (1) плюс тренд в ту же сторону. Развороты считаются с малым весом (они контртрендовые и шумные), поэтому сами по себе вход не дают.',
      ...
      'Когда раунд пропускаем. Нет свежих сигналов (фид молчит); перевес слабый (модуль < 1.5); цена нужной стороны вне полосы 0.35–0.65 (рынок уже согласен с направлением — платить будет мало); не хватает времени или ликвидности. Принцип простой: лучше пропустить, чем войти на шуме.',
