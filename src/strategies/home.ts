    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Каждая стратегия имеет индивидуальный защитный стоп-лосс, не превышающий 8% от цены входа (точное значение подбирается по симуляции прибыльности под каждую стратегию). Это страховка от потери сигнала на закрытие — основной выход стратегия делает сама. Размер позиции фиксированный — 1000 долларов на сделку. На один символ и одну стратегию открыта максимум одна позиция одновременно.',
        },
        {
