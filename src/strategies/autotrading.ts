...
const FAQ_ITEMS_RU: Array<{ q: string; a: string }> = [
    ...
    },
    {
      ...
      a: 'Минимум $300 USDT на Bybit Unified Trading Account (единый торговый аккаунт). Ниже этой суммы автотрейдинг не запускается — это экономически невыгодно ни вам, ни нам (даже подписка съест значимую часть ожидаемой прибыли).',
    },
    {
